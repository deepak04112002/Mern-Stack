...
const LoginDialog = (props) => {
    const [account, toogleAccount] = useState(accountIntialValues.login);
    ...
    const handleClose = () => {
        props.setOpen(false);
        toogleAccount(accountIntialValues.login);
        setError(false);
    }
    const toogleSingup = () => {
        toogleAccount(accountIntialValues.signup);
    }
                        ...
                        </Image>
                        {
                            account.view === 'login' ?
                                <Wrapper>
                                    ...
                                    <CreateAccount onClick={() => toogleSingup()}>New To Flipkart? Create an Account</CreateAccount>
                                </Wrapper>
                                :
                                <Wrapper>
